...
import { View, Text, StyleSheet, ActivityIndicator, Dimensions, FlatList, Alert, Image, ScrollView } from 'react-native';
...
const SalesStatus = ({ navigation }) => {
  ...
  return (
    ...
    <View style={styles.container}>
       <View style={{ maxHeight: Dimensions.get("window").height * 0.95 }}>
