...
import { View, Text, FlatList, Image, TouchableOpacity, StyleSheet, Alert, Dimensions, ScrollView } from 'react-native';
...
const ShoppingCart = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center", margin: 16, marginBottom: 8, maxHeight:"5%" }}>
      ...
      <View style={{
        flex: 1, position: "absolute", top: windowHeight - 42
      }}>
        <View style={styles.summary}>
            <Text style={styles.total}>总金额：${total}</Text>
            <TouchableOpacity style={styles.checkoutButton} onPress={handleCheckout}>
...
const styles = StyleSheet.create({
  ...
  summary: {
    ...
    alignItems: 'center',
    position: 'absolute',
    bottom: 40, // Position above CustBar
    left: 0,
    right: 0,
  },
  total: {
