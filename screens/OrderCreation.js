...
import { View, Text, FlatList, TouchableOpacity, StyleSheet, Alert, Image, Dimensions, ScrollView } from 'react-native';
...
const OrderCreation = ({ navigation, route }) => {
  ...
  return (
    ...
    <ScrollView style={{ flex: 0.99, flexDirection: "column", paddingBottom:50 }}>
      <FlatList style={{
        marginBottom: 30,
