...
import { View, Text, TextInput, StyleSheet, FlatList, TouchableOpacity, ActivityIndicator, Dimensions, ScrollView } from 'react-native';
...
const OrderScreen = ({ navigation }) => {
  ...
  const [itemsPerPage] = useState(1000000000000000);
