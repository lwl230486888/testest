...
// //             <View style={{ flex: 1, height: Platform.OS == "web" ? "30%" : "30%", width:"60%" }}>
...
// //       <AdminBar style={{position:"absolute"}} navigation={navigation} activeScreen="Inventory" />
// //     </View>
// //   );
// // };
...
//           <FlatList style={{ marginBottom: 0, minHeight:Dimensions.get("window").height*0.8 }}
//             data={filteredProducts}
//             renderItem={renderProductItem}
//             keyExtractor={(item) => item.product_id.toString()}
//             ListEmptyComponent={
...
//       )}
//       <View style={{
//         flex: 1, position: "absolute", top: windowHeight - 60
//       }}>
//         <AdminBar navigation={navigation} activeScreen="Inventory" />
//       </View>
//     </SafeAreaView>
