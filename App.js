    ...
    <NavigationContainer onStateChange={handleStateChange}>
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <Stack.Navigator initialRouteName='Login'>
          ...
          <Stack.Screen name="Inventory" component={StockScreen} options={{ headerShown: false }} />
          ...
          <Stack.Screen name="SalesStatus" component={SalesStatus} options={{ headerShown: false }} />
